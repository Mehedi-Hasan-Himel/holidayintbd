      ...
      <section className="body-font relative  text-gray-600 dark:text-white">
        <div className="py-10">
          <div className="flex h-screen items-center justify-center overflow-y-scroll bg-[url('https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center bg-no-repeat px-4 md:px-0 lg:px-0">
            {/* Main content */}
            <div className="animate-slide-up mx-4 mt-8 flex h-[490px] w-full max-w-[440px] flex-col justify-end gap-6 rounded-xl bg-white px-4 md:mx-0 lg:mx-0">
              {/* sign in with social icons */}
              <div className="mx-auto flex w-full max-w-[400px] -translate-y-2 flex-col items-center justify-center gap-7 rounded-lg bg-pink-600 pb-12 pt-5">
              ...
              <div className="px-2">
                ...
                <div className="text-center">
                  <button
                    onClick={handleLogin}
                    className="mt-9 w-full rounded-lg border-none bg-pink-600 py-2.5 text-xs font-bold text-white"
                  >
                    LOGIN
                  </button>
                </div>
